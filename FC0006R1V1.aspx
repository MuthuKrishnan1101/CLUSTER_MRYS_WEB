<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FC0006R1V1.aspx.cs" Inherits="CLUSTER_MRTS.FC0006R1V1" %>
        ...
        <ContentTemplate>
                ...
                <div class="box box-solid Box" style="margin-top: -12px">
                    ...
                    <table width="100%">
                        ...
                        <tr>
                            <td>
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-2 control-label">Cancelled By </label>
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <asp:TextBox ID="txtCancelBy" runat="server" ReadOnly="true" CssClass="ReadOnly form-control"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-sm-1"></div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <asp:TextBox ID="txtCDate" runat="server" CssClass=" form-control" onkeypress="return isDatePicker(event)" OnPaste="JavaScript:return RestrictCopyPasteDatePicker();"></asp:TextBox>
                                        </div>
                                    </div>
                        ...
                        <tr>
                            <td>
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-2 control-label">Cancellation Reason </label>
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <asp:DropDownList ID="ddlCR" runat="server" CssClass="form-control">
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <asp:Panel ID="pnlPaymentDetails" runat="server" Visible="false">
                            <tr>
                                <td>
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-2 control-label">MR Amount S$ </label>
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <asp:TextBox ID="txtMRAmt" runat="server"  ReadOnly="true" CssClass=" form-control  ReadOnly"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-sm-1"></div>
                                        <label for="inputEmail3" class="col-sm-2 control-label">Paid Amount S$</label>
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <asp:TextBox ID="txtPaidAmt" ReadOnly="true" runat="server" CssClass=" form-control ReadOnly"></asp:TextBox>
                                            </div>
                                        </div>
                            ...
                            <tr>
                                <td>
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-2 control-label">Cancellation Charge S$ </label>
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <asp:TextBox ID="txtCancelAmt" runat="server" Enabled="true" CssClass=" form-control"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-sm-1"></div>
                                        <label for="inputEmail3" class="col-sm-2 control-label">Include Cancellation Charge </label>
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <asp:CheckBox runat="server" ID="ChkCanCharge" OnCheckedChanged="ChkCanCharge_CheckedChanged" AutoPostBack="true" class="flagchk" CssClass="form-control" Width="40px" />
                                            </div>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-2 control-label">Refund To </label>
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <asp:TextBox ID="txtRefund" runat="server" Enabled="false" CssClass=" form-control ReadOnly"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="col-sm-1"></div>
                                        <label for="inputEmail3" class="col-sm-2 control-label">Refund Amount S$ </label>
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <asp:TextBox ID="txtRefundAmt" runat="server" Enabled="false" CssClass=" form-control ReadOnly"></asp:TextBox>
                                            </div>
                                        </div>
                            ...
                            <tr>
                                <td>
                                    <div class="form-group">
                                        <label for="inputEmail3" class="col-sm-2 control-label">Refund Payment Mode </label>
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <asp:DropDownList ID="ddlPymtMode" runat="server" CssClass="form-control">
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <tr>
                                <td>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                <asp:TextBox ID="txtReject" runat="server"  CssClass="form-control"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                        ...
                        <tr>
                            <td>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            <asp:TextBox ID="txtRemarks" runat="server" TextMode="MultiLine" Style="resize: none" MaxLength="512" CssClass="MultiLine_Textbox optional form-control"></asp:TextBox>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-xs-11 col-sm-11 col-md-11 text-right">
                            <asp:LinkButton ID="lnkbtApprove" runat="server" CssClass="btn  btngreen" Style="font-size: 13px; line-height: 37px; padding: 0px 15px; border-radius: 15px" OnClick="lnkbtApprove_Click">Approve</asp:LinkButton>
                            <asp:LinkButton ID="lnkbtnReject" runat="server" CssClass="btn  btnred" Style="font-size: 13px; line-height: 37px; padding: 0px 15px; border-radius: 15px" OnClick="lnkbtnReject_Click">Reject</asp:LinkButton>
                        </div>
                    </div>
                    <br />
                    <div class="row">
                        <div class="col-xs-11 col-sm-11 col-md-11 text-right">
                            <asp:LinkButton ID="btncreditnotes" runat="server" CssClass="btn  btngreen" Style="font-size: 13px; line-height: 37px; padding: 0px 15px; border-radius: 15px" OnClick="btncreditnotes_Click"> Print Credit Notes</asp:LinkButton>
                        </div>
                    </div>
                    <br />
                    <div class="box-body">
                                 ...
                                 <div class="form">
                                     ...
                                     <div class="table-responsive table--no-card m-b-30" id="divid">
                                         <asp:GridView ID="gvList" runat="server" GridLines="Vertical" RowStyle-Wrap="true"
                                             ...
                                             CellPadding="2"
                                             ForeColor="#333333"
                                             HorizontalAlign="Center" OnRowDataBound="gvList_RowDataBound"
                                             ...
                                             <Columns>
                                                 ...
                                                 <asp:TemplateField>
                                                     <ItemTemplate>
                                                         ...
                                                         <asp:Label ID="lbldCancellationreason" runat="server" Text="<%#Bind('CANCEL_RSN')%>"></asp:Label>
                                                     </ItemTemplate>
                                                     <HeaderTemplate>
                                                             ...
                                                             <tr>
                                                                 <td class="gridtabletd">
                                                                     <asp:LinkButton ID="lnkbtndoctor_name" runat="server" Font-Underline="false" Font-Bold="true"
                                                                         Text="Cancellation Reason" Font-Names="Arial" ForeColor="White"
                                                                         CommandArgument="CANCEL_RSN"></asp:LinkButton>
                                                                 </td>
                                                             </tr>
                                                             <tr>
                                                             </tr>
                                                 ...
                                                 <asp:TemplateField>
                                                     <ItemTemplate>
                                                         ...
                                                         <asp:Label ID="lbldRejectedreason" runat="server" Text="<%#Bind('reference_1')%>"></asp:Label>
                                                     </ItemTemplate>
                                                     <HeaderTemplate>
                                                         <table style="padding: 0px; margin: 0px; width: 100%; background-color: #00b7d4; border-collapse: collapse;">
                                                             <tr>
                                                                 <td class="gridtabletd">
                                                                     <asp:LinkButton ID="lnkbtnRejectedname" runat="server" Font-Underline="false" Font-Bold="true"
                                                                         Text="Reject Reason" Font-Names="Arial" ForeColor="White"
                                                 ...
                                                 <asp:TemplateField>
                                                     <ItemTemplate>
                                                         <asp:Label ID="lblreCancelled" runat="server" Text="<%#Bind('MODIFIED_BY')%>"></asp:Label>
                                                     </ItemTemplate>
                                                     <HeaderTemplate>
                                                         <table style="padding: 0px; margin: 0px; width: 100%; background-color: #00b7d4; border-collapse: collapse;">
                                                             <tr>
                                                                 <td class="gridtabletd">
                                                                     <asp:LinkButton ID="lnkbtnreCancelled" runat="server" Font-Underline="false" Font-Bold="true"
                                                                         Text="Modified By" Font-Names="Arial" ForeColor="White"
                                                 ...
                                                 <asp:TemplateField>
                                                     <ItemTemplate>
                                                         ...
                                                         <asp:Label ID="lblaMODIFIED_ONe" runat="server" Text='<%#Bind("MODIFIED_ON", "{0:dd-MM-yyyy}")%>'></asp:Label>
                                                     </ItemTemplate>
                                                     <HeaderTemplate>
                                                         <table style="padding: 0px; margin: 0px; width: 100%; background-color: #00b7d4; border-collapse: collapse;">
                                                             <tr>
                                                                 <td class="gridtabletd">
                                                                     <asp:LinkButton ID="lnkbtnMODIFIED_ONdate" runat="server" Font-Underline="false" Font-Bold="true"
                                                                         Text="Modified Date" Font-Names="Arial" ForeColor="White"
                                                                         CommandArgument="MODIFIED_ON"></asp:LinkButton>
                                                                 </td>
                                                             </tr>
                                                             <tr>
                                                             </tr>
                                                ...
                                                <asp:TemplateField>
                                                     <ItemTemplate>
                                                         <asp:Label ID="lblStatus" runat="server" Text="<%#Bind('SUP_STATUS')%>"></asp:Label>
                                                     </ItemTemplate>
                                                     <HeaderTemplate>
                                                         <table style="padding: 0px; margin: 0px; width: 100%; background-color: #00b7d4; border-collapse: collapse;">
                                                             <tr>
                                                                 <td class="gridtabletd">
                                                                     <asp:LinkButton ID="lnkbtnreqid" runat="server" Font-Underline="false" Font-Bold="true"
                                                                         Text="Status" Font-Names="Arial" ForeColor="White"
                                                                         CommandArgument="SUP_STATUS"></asp:LinkButton>
                                                                 </td>
                                                             </tr>
                                                             <tr>
                                                             </tr>
                                    ...
                                    <center>
                                        <table style="width: 98%; text-align: center" bgcolor="#f4eaff">
                                            <tr>
                                                ...
                                                <td style="width: 70%; text-align: center; font-family: Arial, Helvetica, sans-serif; font-size: medium; font-weight: bold; color: #000080;"
                                                    height="30px">
                                                    <asp:Label ID="Label1" runat="server" Text="Cancellation Approved" ForeColor="#212529" Font-Bold="True" Font-Names="Arial" Font-Size="20pt"></asp:Label>
                                                </td>
                                                <td style="width: 10%"></td>
                                            </tr>
                                            <tr>
                                                <td colspan="3" style="height: 96px">
                                                    ...
                                                    <asp:Panel ID="Panel2" runat="server" Height="67px">
                                                        <table style="width: 100%">
                                                            <tr>
                                                                <td style="width: 28%; font-family: Arial, Helvetica, sans-serif; font-weight: bold; color: orangered; font-size: 12pt">Approved Cancellation ?</td>
                                                            </tr>
                                                        </table>
                                                    </asp:Panel>
                                                </td>
                                            ...
                                            <tr>
                                                <td colspan="3" style="text-align: center">
                                                    <asp:Button ID="btnconfirncancel" runat="server" align="right" CssClass="btn btngreen"
                                                        Text="Yes" />
                                                    <asp:Button ID="btncancelclose" runat="server" align="right" CssClass="btn btnred"
                                                        Text="NO" />
                                                </td>
                                            </tr>
                                            <tr>
            ...
            <asp:Panel runat="server" ID="pnlupdateremarksandprocess">
                <table width="100%">
                    <tr>
                        <td>
                           <asp:UpdatePanel ID="UpdatePanelProcessUpdate" runat="server">
                                <ContentTemplate>
                                    <asp:LinkButton ID="btnpopupProcessUpdate" runat="server" />
                                    <cc1:ModalPopupExtender ID="ModalPopupProcessUpdate" runat="server" BackgroundCssClass="modal-background"
                                        DynamicControlID="btnPopupProcessUpdate" PopupControlID="pnlPopupProcessUpdate" DynamicServiceMethod="GetContextKeyGroupHistory" DynamicServicePath="~/WebService.asmx" RepositionMode="RepositionOnWindowResizeAndScroll"
                                        TargetControlID="btnpopupProcessUpdate" />
                                    <asp:Panel ID="pnlpopupProcessUpdate" runat="server" BackColor="#e3f6fd"
                                        EnableTheming="True" Style="text-align: center; resize: none; align-content: flex-start; align-items: flex-start; border: 5px solid #2aa7ed; border-radius: 20px; padding: 10px;" Width="447px">
                                        <center>
                                            <table style="width: 98%; text-align: center" bgcolor="#f4eaff">
                                                <tr>
                                                    ...
                                                    <td align="center">
                                                        <asp:Label Style="text-align: center" ID="Label2" runat="server" Text="Update Process" ForeColor="#212529" Font-Bold="True" Font-Names="Arial" Font-Size="20pt"></asp:Label>
                                                    </td>
                                                    <td style="width: 10%"></td>
                                                </tr>
                                                <tr>
  ...
  <asp:UpdatePanel ID="UpdatePanel58" runat="server">
                <ContentTemplate>
                    <div style="height: 790px;">
                                ...
                                <%--<div class="modal-footer" style="text-align: center;">
                                    <asp:Button runat="server" ID="Button1" Text="Close" CssClass="btn btnred Backcolor"   />
                                </div>--%>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="accordion-group">
                                        ...
                                        <div id="collapseThree" class="accordion-body collapse in">
                                            <div class="accordion-inner">
                                                <asp:Panel ID="Panel1" Width="100%" runat="server" Style="margin-left: 20px;">
                                                    <div class="form-horizontal">
                                                        <div class="box-body">
                                                            <div class="form-group">
                                                                   <div class="col-sm-3">
