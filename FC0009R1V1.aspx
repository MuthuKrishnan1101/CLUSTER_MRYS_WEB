<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FC0009R1V1.aspx.cs" Inherits="CLUSTER_MRTS.FC0009R1V1" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            ...
            <div class="card">
                ...
                <div class="box  box-solid Box" style="margin-top: -12px; padding: 10px">
                    <div class="accordion-group">
                        <div class="accordion-heading">
                            <span class="accordion-toggle" data-toggle="collapse" data-parent="toggle" href="#collapseOne">
                                <i class="fa fa-minus"></i>&nbsp;Task Details
                            </span>
                        </div>
                        <div id="collapseOne" class="accordion-body collapse in">
                            <div class="accordion-inner">
                                <asp:Panel ID="pnlGeneralDetails" Width="90%" runat="server">
                                    <div class="form-horizontal">
                                        <div class="box-body">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <asp:TextBox ID="txttaskname" MaxLength="50" Wrap="False" runat="server" ReadOnly="true" CssClass="ReadOnly form-control" Style="margin-left: 30px"></asp:TextBox>
                                                    </div>
                                                </div>
                                                <div class="col-sm-1"></div>
                                                <label for="inputEmail3" class="col-sm-3 control-label">Last Reminder Date </label>
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <asp:TextBox ID="txtLastRemainderDate" runat="server" Enabled="false" CssClass="ReadOnly form-control" autocomplete="off" Style="margin-left: -52px"></asp:TextBox>
                                                        <cc1:CalendarExtender ID="txtdateform_CalendarExtender" TargetControlID="txtLastRemainderDate" runat="server"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="inputEmail3" class="col-sm-2 control-label">Task Start Date </label>
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <asp:TextBox ID="txtTaskStartDate" runat="server" Enabled="false" CssClass="ReadOnly form-control" autocomplete="off" Style="margin-left: 30px"></asp:TextBox>
                                                        <cc1:CalendarExtender ID="txtdateto_CalendarExtender" TargetControlID="txtTaskStartDate" runat="server"
                                                            Format="dd-MM-yyyy"></cc1:CalendarExtender>
                                                    </div>
                                                </div>
                                                <div class="col-sm-1"></div>
                                                <label for="inputEmail3" class="col-sm-3 control-label">Task Due Date</label>
                                                <div class="col-sm-3">
                                                    <div class="form-group">
                                                        <asp:TextBox ID="txtTaskDueDate" runat="server" Enabled="false" CssClass="ReadOnly form-control" autocomplete="off" Style="margin-left: -52px"></asp:TextBox>
                                                        <cc1:CalendarExtender ID="CalendarExtender1" TargetControlID="txtTaskDueDate" runat="server"
                                                            Format="dd-MM-yyyy"></cc1:CalendarExtender>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="box-body">
                                            <div class="form">
                                                ...
                                                <div class="table-responsive table--no-card m-b-30" id="divid">
                                                    <asp:GridView ID="gvList" runat="server" GridLines="Vertical" RowStyle-Wrap="true" OnRowDataBound="gvList_RowDataBound"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField>
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:Label ID="lblTaskname" runat="server" Text="<%#Bind('long_name')%>"></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderTemplate>
                                                                        ...
                                                                        <tr>
                                                                            <td class="gridtabletd">
                                                                                <asp:LinkButton ID="lnkbtnDueDays" runat="server" Font-Underline="false" Font-Bold="true"
                                                                                    Text="Task Name" OnClick="lnkbtnSort_Click" Font-Names="Arial" ForeColor="White"
                                                                                    CommandArgument="long_name"></asp:LinkButton>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                        </tr>
                                                            ...
                                                            <asp:TemplateField>
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lbldelayreason" runat="server"></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderTemplate>
                                                                    <table style="padding: 0px; margin: 0px; width: 100%; background-color: #00b7d4; border-collapse: collapse;">
                                                                        <tr>
                                                                            <td class="gridtabletd">
                                                                                <asp:LinkButton ID="lnkbtnPending_Status" runat="server" Font-Underline="false" Font-Bold="true"
                                                                                    Text="Delay Reason" OnClick="lnkbtnSort_Click" Font-Names="Arial" ForeColor="White"
                                                            ...
                                                            <asp:TemplateField>
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblCreatedby" runat="server" Text="<%#Bind('MODIFIED_BY')%>"></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderTemplate>
                                                                    <table style="padding: 0px; margin: 0px; width: 100%; background-color: #00b7d4; border-collapse: collapse;">
                                                                        <tr>
                                                                            <td class="gridtabletd">
                                                                                <asp:LinkButton ID="lnkbtnCreatedby" runat="server" Font-Underline="false" Font-Bold="true"
                                                                                    Text="Created By" OnClick="lnkbtnSort_Click" Font-Names="Arial" ForeColor="White"
                                                            ...
                                                            <asp:TemplateField>
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:Label ID="lblClosedte" runat="server" Text='<%#Bind("MODIFIED_ON", "{0:dd-MM-yyyy}")%>'></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderTemplate>
                                                                    <table style="padding: 0px; margin: 0px; width: 100%; background-color: #00b7d4; border-collapse: collapse;">
                                                                        <tr>
                                                                            <td class="gridtabletd">
                                                                                <asp:LinkButton ID="lnkbtnprocesssts6014" runat="server" Font-Underline="false" Font-Bold="true"
                                                                                    Text="Created Date" OnClick="lnkbtnSort_Click" Font-Names="Arial" ForeColor="White"
                    ...
                    <div class="accordion-group">
                        <div class="accordion-heading">
                            <span class="accordion-toggle" data-toggle="collapse" data-parent="toggle" href="#collapseTwo">
                                <i class="fa fa-minus"></i>&nbsp;Recall Reason
                            </span>
                        </div>
                            ...
                            <div class="accordion-inner">
                                ...
                                <div class="box-body">
                                    <div class="box box-primary box-solid" style="border-radius: 33px; border: 1px dashed #2aa7ed">
                                        <div class="box-header with-border TotalRecord">
                                            <div class="box-title">
                                                <label class="text-right" style="color: white">Total Record Recall History : <span id="TotalrecallCount" runat="server"></span></label>
                                            </div>
                                        </div>
                                        <div class="box-body">
                                            <div class="form">
                                                <asp:HiddenField ID="HiddenField1" runat="server" />
                                                <div class="table-responsive table--no-card m-b-30" id="dividrecall">
                                                    <asp:GridView ID="gvlistrecall" runat="server" GridLines="Vertical" RowStyle-Wrap="true"
                                                        AutoGenerateColumns="False"
                                                        CellPadding="2"
                                                        ForeColor="#333333"
                                                        HorizontalAlign="Center"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField>
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:Label ID="lblrecallreason" runat="server" Text="<%#Bind('DESCRIPTION')%>"></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderTemplate>
                                                                    <table style="padding: 0px; margin: 0px; width: 100%; background-color: #00b7d4; border-collapse: collapse;">
                                                                        <tr>
                                                                            <td class="gridtabletd">
                                                                                <asp:LinkButton ID="lnkbtnRecallreason" runat="server" Font-Underline="false" Font-Bold="true"
                                                                                    Text="Recall Reason" OnClick="lnkbtnSortrecall_Click" Font-Names="Arial" ForeColor="White"
                                                                                    CommandArgument="DESCRIPTION"></asp:LinkButton>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                        </tr>
                                                            ...
                                                            <asp:TemplateField>
                                                                <ItemTemplate>
                                                                    <asp:Label ID="lblRecallby" runat="server" Text="<%#Bind('MODIFIED_BY')%>"></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderTemplate>
                                                                    <table style="padding: 0px; margin: 0px; width: 100%; background-color: #00b7d4; border-collapse: collapse;">
                                                                        <tr>
                                                                            <td class="gridtabletd">
                                                                                <asp:LinkButton ID="lnkbtnRecallby" runat="server" Font-Underline="false" Font-Bold="true"
                                                                                    Text="Recall By" Font-Names="Arial" OnClick="lnkbtnSortrecall_Click" ForeColor="White"
                                                                                    CommandArgument="MODIFIED_BY"></asp:LinkButton>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                            ...
                                                            <asp:TemplateField>
                                                                <ItemTemplate>
                                                                    ...
                                                                    <asp:Label ID="lblRecalldte" runat="server" Text='<%#Bind("MODIFIED_ON", "{0:dd-MM-yyyy}")%>'></asp:Label>
                                                                </ItemTemplate>
                                                                <HeaderTemplate>
                                                                    <table style="padding: 0px; margin: 0px; width: 100%; background-color: #00b7d4; border-collapse: collapse;">
                                                                        <tr>
                                                                            <td class="gridtabletd">
                                                                                <asp:LinkButton ID="lnkbtnRecalldate" runat="server" Font-Underline="false" Font-Bold="true"
                                                                                    Text="Recall Date" Font-Names="Arial" OnClick="lnkbtnSortrecall_Click" ForeColor="White"
                                                                                    CommandArgument="MODIFIED_ON"></asp:LinkButton>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
