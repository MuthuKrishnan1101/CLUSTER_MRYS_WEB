<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FE0005R1V1.aspx.cs" Inherits="CLUSTER_MRTS.FE0005R1V1" %>
        ...
        <ContentTemplate>
            ...
            <table width="100%">
                 ...
                 <asp:ImageButton ID="imgbtnClear" runat="server" class="MenuImageButton" ImageUrl="Images/MenuTemplatesImg/CLEAR_MENU.png"
                     ToolTip="Clear All the Entries" OnClick="imgBtnSearch_Click"  />--%>
            ...
            <div class="box  box-solid" style="border-radius: 33px; border: 1px dashed #2aa7ed">
                        ...
                        <div class="table-responsive table--no-card m-b-30" id="divid">
                                <asp:GridView ID="gvList" runat="server" GridLines="Vertical" RowStyle-Wrap="true"
                                    ...
                                    <Columns>
                                                    ...
                                                    <tr>
                                                        <td class="gridtabletd">
                                                            <asp:LinkButton ID="Linkbutton1" runat="server" Font-Underline="false" Font-Bold="true"
                                                                ...
                                                                CommandArgument="mrenq.request_id" OnClick="LnkbtnSort_Click">
                                                            </asp:LinkButton>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td class="gridtabletd">
                                                            <asp:LinkButton ID="lnkbtnprocesssts7" runat="server" Font-Underline="false" Font-Bold="true"
                                                                ...
                                                                CommandArgument="mrpats.HRN_ID" OnClick="LnkbtnSort_Click"></asp:LinkButton>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td class="gridtabletd">
                                                            <asp:LinkButton ID="lnkbtnHeadershortName9" runat="server" Font-Underline="false" Font-Bold="true"
                                                                ...
                                                                CommandArgument="inref.INDEX_VALUE" OnClick="LnkbtnSort_Click"></asp:LinkButton>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td class="gridtabletd">
                                                            <asp:LinkButton ID="lnkEXPECTED_DATE" runat="server" Font-Underline="false" Font-Bold="true"
                                                                ...
                                                                CommandArgument="mrenq.ENQ_DATE" OnClick="LnkbtnSort_Click"></asp:LinkButton>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td class="gridtabletd">
                                                            <asp:LinkButton ID="lnkbtnprocesssts6" runat="server" Font-Underline="false" Font-Bold="true"
                                                                Text="Enquiry Description" Font-Names="Arial"  ForeColor="White"
                                                                CommandArgument="mrenq.CALLERS_ENQUIRY" OnClick="LnkbtnSort_Click"></asp:LinkButton>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    </tr>
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:Label ID="lblmr_status" runat="server" Text="<%#Bind('MR_STATUS')%>"></asp:Label>
                                            </ItemTemplate>
                                            <HeaderTemplate>
                                                <table style="padding: 0px; margin: 0px; width: 100%; background-color: #00b7d4; border-collapse: collapse;">
                                                    <tr>
                                                        <td class="gridtabletd">
                                                            <asp:LinkButton ID="lnkbtnprocessst16" runat="server" Font-Underline="false" Font-Bold="true"
                                                                Text="MR Status" Font-Names="Arial"  ForeColor="White"
                                                                CommandArgument="mrreg.MR_STATUS" OnClick="LnkbtnSort_Click"></asp:LinkButton>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    </tr>
                                        ...
                                        <asp:TemplateField>
                                            ...
                                            <HeaderTemplate>
                                                <table style="padding: 0px; margin: 0px; width: 100%; background-color: #00b7d4; border-collapse: collapse;">
                                                    <tr>
                                                        <td class="gridtabletd">
                                                            <asp:LinkButton ID="lnkbtnprocesssfts6" runat="server" Font-Underline="false" Font-Bold="true"
                                                                Text="Enquiry Status" Font-Names="Arial"  ForeColor="White"
                                                                CommandArgument="mrenq.REFERENCE_1" OnClick="LnkbtnSort_Click"></asp:LinkButton>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td class="gridtabletd">
                                                            <asp:LinkButton ID="lnkbtnMODIFIED_BY" runat="server" Font-Underline="false" Font-Bold="true"
                                                                ...
                                                                CommandArgument="mrenq.MODIFIED_BY" OnClick="LnkbtnSort_Click"></asp:LinkButton>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    </tr>
                                    ...
                                    <asp:Repeater ID="rptPagergvInvoicegvList" runat="server">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkPage" runat="server" Text='<%#Eval("Text") %>' CommandArgument='<%# Eval("Value") %>'
                                                CssClass='<%# Convert.ToBoolean(Eval("Enabled")) ? "page_enabled" : "page_disabled" %>' OnClick="lnkPagegvList_Click"></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:Repeater>
                                </div>
                            </div>
