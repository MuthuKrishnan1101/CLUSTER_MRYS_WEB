<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FA0037R1V1.aspx.cs" Inherits="CLUSTER_MRTS.FA0037R1V1" %>
       ...
       <div class="ToolBarcard">
         <div class="row">
               <div class="col-xs-12 col-sm-12 col-md-12 text-right ToolBar">
                 ...
                 <asp:ImageButton ID="imgbtnSearch" runat="server" class="MenuImageButton" ImageUrl="Images/MenuTemplatesImg/CLEAR_MENU.png"
                                 ...
                                 <div class="form-horizontal">
                                      <div class="box-body">
                                         <div class="form-group">
                                             <label for="inputEmail3" class="col-sm-2 control-label"> Public Holiday ID  </label>
                                             <div class="col-sm-3">
                                                 <div class="form-group">
                                                   
                                                          <asp:TextBox ID="txtpublicid" runat="server"  ToolTip="Public Holiday ID" CssClass="form-control" ReadOnly="false"   style="resize: none;text-transform: uppercase;"  ></asp:TextBox>
                                                 </div>
                                             </div>
                                             <%--<div class="col-sm-1">
                                             </div>--%>
                                         ...
                                         <div class="form-group">
                                             <label for="inputEmail3" class="col-sm-2 control-label">Public Holiday Description  </label>
                                             <div class="col-sm-8">
                                                 <div class="form-group">
                                                    
                                                      <asp:TextBox ID="txtpublicholiday" runat="server" ToolTip="Public Holiday Description" CssClass="form-control" ReadOnly="false" TextMode="MultiLine"  style="resize: none;height:70px;text-transform:uppercase;"  ></asp:TextBox>
                                                 </div>
                                             </div>
                                            <%-- <div class="col-sm-1">
                                             </div>
                                         ...
                                         <div class="form-group">
                                             ...
                                             <div class="col-sm-3">
                                                 <div class="form-group">
                                                     <asp:TextBox ID="txtdatefrom" runat="server" ToolTip="Date From" CssClass="form-control" ReadOnly="false"   style="resize: none" onkeypress="return isDatePicker(event)" OnPaste="JavaScript:return RestrictCopyPasteDatePicker();" ></asp:TextBox>
                                                      <cc1:CalendarExtender ID="txtdatefrom_Calender" runat="server"
                                Format="dd-MM-yyyy" TargetControlID="txtdatefrom"> </cc1:CalendarExtender>
                                                 </div>
                                             </div>
                                             <label for="inputEmail3" class="col-sm-2 control-label">Date To  </label>
                                             <div class="col-sm-3">
                                                <div class="form-group">
                                                    <asp:TextBox ID="txtdateto" runat="server" ToolTip="Date To" CssClass="form-control" ReadOnly="false"   style="resize: none" onkeypress="return isDatePicker(event)" OnPaste="JavaScript:return RestrictCopyPasteDatePicker();"  ></asp:TextBox>
                                                     <cc1:CalendarExtender ID="txtDOB_CalendarExtender" runat="server"
                                Format="dd-MM-yyyy" TargetControlID="txtdateto"> </cc1:CalendarExtender>
                                                 </div>
                                             </div>
