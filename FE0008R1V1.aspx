<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FE0008R1V1.aspx.cs" Inherits="CLUSTER_MRTS.FE0008R1V1" %>
                            ...
                            <ContentTemplate>
                                <asp:HiddenField ID="hfTabID" runat="server" Value="#tab_1" />
                                  <span hidden> <asp:Button ID="btntriggertab1" runat="server" Text="ALL" OnClick="btntriggertab1_Click " CssClass="btnTabs" BackColor="#397279" ForeColor="white" />&nbsp;</span>
                                    <asp:Button ID="btntriggertab2" runat="server" Text="Pending Waiver Approval" OnClick="btntriggertab2_Click" CssClass="btnTabs" BackColor="#397279" ForeColor="white" />&nbsp;
                                    <asp:Button ID="btntriggertab3" runat="server" Text="Pending Cancellation Approval" OnClick="btntriggertab3_Click" CssClass="btnTabs" BackColor="#63bff7" ForeColor="white" />&nbsp;                                
                                    <asp:Button ID="btntriggertab4" runat="server" Text="Pending Supervisor Vetting" OnClick="btntriggertab4_Click" CssClass="btnTabs" BackColor="#63bff7" ForeColor="white" />&nbsp;
                                    <asp:Button ID="btntriggertab5" runat="server" Text="Pending Report Verification" OnClick="btntriggertab5_Click" CssClass="btnTabs" BackColor="#63bff7" ForeColor="white" />&nbsp;
                            </ContentTemplate>
                        </asp:UpdatePanel>
                    </div>
                                                                        ...
                                                                        <tr>
                                                                            <td class="gridtabletd">
                                                                                <asp:LinkButton ID="lnkbtnpDepartments" runat="server" Font-Underline="false" Font-Bold="true"
                                                                                    ...
                                                                                    CommandArgument="REFERENCE_3" OnClick="LnkbtnSort_Click"></asp:LinkButton>
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                        </tr>
                    ...
                    <div class="modal bs-example-modal-lg in display-block" style="overflow: scroll;">
                        <div class="modal-dialog modal-lg panelBiodata" style="width: 40%;">
                            <div class="modal-content PopupModelContent">
                                ...
                                <div class="box-body">
                                    <div class="form">
                                        ...
                                        <div class="table-responsive table--no-card m-b-30">
                                            <asp:GridView ID="gvlistBATCHPROLILE" runat="server" GridLines="Vertical" RowStyle-Wrap="false" AutoGenerateColumns="false" OnRowDataBound="gvlistBATCHPROLILE_RowDataBound"
                                ...
                                <div class="modal-footer" style="text-align: center;">
                                    <asp:Button runat="server" ID="btnokBATCHPROLILE" Text="Ok" OnClick="btnokBATCHPROLILE_Click" CssClass="btn btn-success" />
                                </div>
                            </div>
                        </div>
                    </div>
